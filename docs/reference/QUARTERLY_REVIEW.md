...
## 1. Company watchlist — `docs/reference/company-watchlist.md`
...
- [ ] Update "Last updated" date in `docs/reference/company-watchlist.md`
...
| Company watchlist | `docs/reference/company-watchlist.md` | same file |
