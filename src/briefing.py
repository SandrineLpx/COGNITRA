...
def _build_synthesis_prompt(records: List[Dict], week_range: str) -> str:
    ...
    region_section = (
        ...
        "- Do NOT mix parent buckets and child regions in the same section (e.g., Europe + Germany, South America + Mercosul).\n"
        ...
        if not mode["include_empty_regions"]
            ...
            "If a region has no signal, omit it.\n"
    ...
    actions_section = (
        ...
        if is_single
            ...
            "  * Trigger/watch condition (if/when threshold)\n"
